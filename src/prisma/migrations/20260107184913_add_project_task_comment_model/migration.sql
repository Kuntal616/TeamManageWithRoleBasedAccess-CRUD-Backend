...
-- CreateIndex
CREATE INDEX "tasks_asigneeId_idx" ON "tasks"("asigneeId");
...
-- AddForeignKey
ALTER TABLE "tasks" ADD CONSTRAINT "tasks_asigneeId_fkey" FOREIGN KEY ("asigneeId") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE CASCADE;
